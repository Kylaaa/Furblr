...
data class User(
    ...
    // stats
    @ColumnInfo(name = "$USERS_COLUMN_NAME_STATS_VIEW_COUNT") var statsViewsCount : Long,
    @ColumnInfo(name = "$USERS_COLUMN_NAME_STATS_SUBMISSIONS_COUNT") var statsSubmissionsCount : Long,
    @ColumnInfo(name = "$USERS_COLUMN_NAME_STATS_FAVORITES_COUNT") var statsFavoritesCount : Long,
    @ColumnInfo(name = "$USERS_COLUMN_NAME_STATS_COMMENTS_EARNED_COUNT") var statsCommentsEarned : Long,
    @ColumnInfo(name = "$USERS_COLUMN_NAME_STATS_COMMENTS_MADE_COUNT") var statsCommentsMade : Long,
    @ColumnInfo(name = "$USERS_COLUMN_NAME_STATS_JOURNALS_COUNT") var statsJournalsCount : Long,

    // money
    @ColumnInfo(name = "$USERS_COLUMN_NAME_ACCEPTING_TRADES") var acceptingTrades : Boolean,
    @ColumnInfo(name = "$USERS_COLUMN_NAME_ACCEPTING_COMMISSIONS") var acceptingCommissions : Boolean,
    @ColumnInfo(name = "$USERS_COLUMN_NAME_ACCEPTING_SHINIES") var acceptingShinies : Boolean,
